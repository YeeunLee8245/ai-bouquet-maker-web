...
import { bouquetPackagingColorAtom, bouquetRibbonColorAtom } from '../model';
  ...
  return (
    <div className='mt-4 p-4 border-1 border-gray-100 rounded-5 bg-white'>
      ...
      <div className='mt-3 px-micro grid grid-cols-1 grid-rows-2 gap-y-4'>
        <BouquetPackagingSection title='포장지' colorAtom={bouquetPackagingColorAtom} />
        <BouquetPackagingSection title='리본' colorAtom={bouquetRibbonColorAtom} />
      </div>
    </div>
  );
}
