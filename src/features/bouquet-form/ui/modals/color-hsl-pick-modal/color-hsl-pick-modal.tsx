...
function ColorHSLPickModal({ modalId, onConfirm, initialLightness = 50, existingColors = [] }: TProps) {
  ...
  return (
    <div className='relative flex flex-col w-[360px] min-h-[584px] bg-gray-50 rounded-t-5 tablet:rounded-5 px-4 pt-4 pb-8 tablet:px-6 tablet:pt-6'>
      ...
      <Button size='lg' className='w-full mt-auto' onClick={handleConfirm}>
        선택 완료
      </Button>
    </div>
  );
