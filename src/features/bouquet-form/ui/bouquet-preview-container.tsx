...
export default function BouquetPreviewContainer() {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      aria-label='꽃다발 미리보기'
      className='mt-4 tablet:mt-0 p-4 w-full border-1 border-gray-100 rounded-5 bg-white text-start hover:border-gray-200 hover:shadow-sm'
    >
      <p className='text-title-md px-micro'>꽃다발 미리보기</p>
      <p className='mt-1 text-body-md text-gray-400 px-micro whitespace-pre-wrap'>
