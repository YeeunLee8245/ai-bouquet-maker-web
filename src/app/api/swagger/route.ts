      ...
      components: {
        schemas: {
          ...
          BouquetFlowerItem: {
            ...
            properties: {
              flower_id: { type: 'integer', example: 1, description: '꽃 기본 ID (flowers 테이블)' },
              ...
              flower_meaning_id: { type: 'integer', nullable: true, example: 1, description: '선택한 꽃말 ID (flower_meanings 테이블)' },
